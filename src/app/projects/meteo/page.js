                    ...
                    <div className="my-4">
                        <div className="mb-4">
                            ...
                            <p className="text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                In 2022, I embarked on a digital transformation journey when I enrolled in a computer
                                science course that delved into the creation of an online portfolio. At that juncture, I
